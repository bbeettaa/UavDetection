...
public class FarnebackTR {
    public static void main(String[] args) throws Exception {
        String videoPath = "/home/bedu/Документы/cam.mp4";
        FFmpegFrameGrabber grabber = new FFmpegFrameGrabber(videoPath);
        grabber.start();

        CanvasFrame canvas = new CanvasFrame("Оптичний потік (Farneback)");
...
//            resize(nextGray, nextGray, new Size(640, 480));
            ...
            // Копія зображення для візуалізації
            Mat vis = new Mat(nextMat);
//            resize(nextMat, vis, new Size(640, 480));
