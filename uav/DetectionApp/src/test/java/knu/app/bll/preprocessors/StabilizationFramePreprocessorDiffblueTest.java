...
class StabilizationFramePreprocessorDiffblueTest {

  /**
   * Test {@link StabilizationFramePreprocessor#process(Mat)}.
   *
   * <p>Method under test: {@link StabilizationFramePreprocessor#process(Mat)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Mat StabilizationFramePreprocessor.process(Mat)"})
  void testProcess() {
    ...
    // Arrange
    StabilizationFramePreprocessor stabilizationFramePreprocessor =
        new StabilizationFramePreprocessor();

    // Act
    stabilizationFramePreprocessor.process(new Mat());
