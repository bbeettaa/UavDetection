...
class YoloServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DetectObjects = channel.unary_unary(
                ...
                request_serializer=yolo__pb2.ImageRequest.SerializeToString,
...
def add_YoloServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DetectObjects': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=yolo__pb2.ImageRequest.FromString,
...
class YoloService(object):
    ...
    def DetectObjects(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yolo.YoloService/DetectObjects',
            yolo__pb2.ImageRequest.SerializeToString,
